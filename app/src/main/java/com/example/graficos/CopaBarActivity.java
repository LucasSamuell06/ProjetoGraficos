...
public class CopaBarActivity extends AppCompatActivity {

    private List<String> xvalues = Arrays.asList("Palmeiras", "Santos", "Flamengo", "Corinthias", "São Paulo", "Cruzeiro", "Fluminense");

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_copa_bar);
        ...
        BarDataSet dataSet = new BarDataSet(entries,"Campeões da Copa do Brasil");
